...
/**
 * This is the item provider adapter for a {@link ciat.Team} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TeamItemProvider extends SociogramNodeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Team_contains_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Team_contains_feature", "_UI_Team_type"),
				 CiatPackage.Literals.TEAM__CONTAINS,
				 true,
				 false,
				 true,
				 null,
