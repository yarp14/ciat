...
/**
 * This is the item provider adapter for a {@link ciat.Group} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GroupItemProvider extends SociogramNodeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Group_contains_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Group_contains_feature", "_UI_Group_type"),
				 CiatPackage.Literals.GROUP__CONTAINS,
				 true,
				 false,
				 true,
				 null,
