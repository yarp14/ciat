...
/**
 * This is the item provider adapter for a {@link ciat.CTTDiagram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CTTDiagramItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CiatPackage.Literals.CTT_DIAGRAM__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CiatPackage.Literals.CTT_DIAGRAM__CTT_TASKS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CiatPackage.Literals.CTT_DIAGRAM__CTT_TASKS,
				 CiatFactory.eINSTANCE.createCTTTask()));

		newChildDescriptors.add
			(createChildParameter
				(CiatPackage.Literals.CTT_DIAGRAM__CTT_TASKS,
				 CiatFactory.eINSTANCE.createExclusiveEdition()));

		newChildDescriptors.add
			(createChildParameter
				(CiatPackage.Literals.CTT_DIAGRAM__CTT_TASKS,
				 CiatFactory.eINSTANCE.createCollaborativeVisualization()));

		newChildDescriptors.add
			(createChildParameter
				(CiatPackage.Literals.CTT_DIAGRAM__CTT_TASKS,
				 CiatFactory.eINSTANCE.createIndividualVisualization()));

		newChildDescriptors.add
			(createChildParameter
				(CiatPackage.Literals.CTT_DIAGRAM__CTT_TASKS,
				 CiatFactory.eINSTANCE.createUserTask()));

		newChildDescriptors.add
			(createChildParameter
				(CiatPackage.Literals.CTT_DIAGRAM__CTT_TASKS,
				 CiatFactory.eINSTANCE.createCTTAbstractTask()));

		newChildDescriptors.add
			(createChildParameter
				(CiatPackage.Literals.CTT_DIAGRAM__CTT_TASKS,
				 CiatFactory.eINSTANCE.createInteractiveTask()));

		newChildDescriptors.add
			(createChildParameter
				(CiatPackage.Literals.CTT_DIAGRAM__CTT_TASKS,
				 CiatFactory.eINSTANCE.createCTTCollaborativeTask()));

		newChildDescriptors.add
			(createChildParameter
				(CiatPackage.Literals.CTT_DIAGRAM__CTT_TASKS,
				 CiatFactory.eINSTANCE.createApplicationTask()));
	}
