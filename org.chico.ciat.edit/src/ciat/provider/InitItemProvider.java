...
/**
 * This is the item provider adapter for a {@link ciat.Init} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InitItemProvider extends ProcessNodeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Init_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Init_name_feature", "_UI_Init_type"),
				 CiatPackage.Literals.INIT__NAME,
				 false,
				 false,
				 false,
