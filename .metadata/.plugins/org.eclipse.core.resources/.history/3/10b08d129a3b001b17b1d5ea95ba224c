...
import ciat.diagram.edit.policies.UserTaskItemSemanticEditPolicy;
import ciat.diagram.part.CiatVisualIDRegistry;

/**
 * @generated
 */
public class UserTaskEditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new UserTaskFigure();
	}

	/**
	* @generated
	*/
	public UserTaskFigure getPrimaryShape() {
		return (UserTaskFigure) primaryShape;
	}
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof UserTaskNameEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CiatVisualIDRegistry.getType(UserTaskNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class UserTaskFigure extends figures.UserTaskFigure {
