...
public class CiatOCLFactory {
	...
	* @generated
	*/
	private final CiatAbstractExpression[] expressions;
	...
	*/
	protected CiatOCLFactory() {
		this.expressions = new CiatAbstractExpression[34];
	...
	*/
	private static CiatOCLFactory getInstance() {
		CiatOCLFactory instance = CiatDiagramEditorPlugin.getInstance().getCiatOCLFactory();
		if (instance == null) {
			CiatDiagramEditorPlugin.getInstance().setCiatOCLFactory(instance = new CiatOCLFactory());
		}
		return instance;
	}
	...
	* @generated
	*/
	public static CiatAbstractExpression getExpression(int index, EClassifier context,
	...
	* @generated
	*/
	public static CiatAbstractExpression getExpression(String body, EClassifier context,
			Map<String, EClassifier> environment) {
	...
	* @generated
	*/
	private static class Expression extends CiatAbstractExpression {
