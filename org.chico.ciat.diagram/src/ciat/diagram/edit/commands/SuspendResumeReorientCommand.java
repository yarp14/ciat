 ...
 * @generated
 */
public class SuspendResumeReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public SuspendResumeReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof SuspendResume) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return CiatBaseItemSemanticEditPolicy.getLinkConstraints().canExistSuspendResume_4014(container, getLink(),
				getNewSource(), target);
	}
	...
	* @generated
	*/
	protected SuspendResume getLink() {
		return (SuspendResume) getElementToEdit();
	}
