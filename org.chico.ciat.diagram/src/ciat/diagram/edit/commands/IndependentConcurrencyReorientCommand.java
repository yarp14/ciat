 ...
 * @generated
 */
public class IndependentConcurrencyReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public IndependentConcurrencyReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof IndependentConcurrency) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return CiatBaseItemSemanticEditPolicy.getLinkConstraints().canExistIndependentConcurrency_4012(container,
	...
	* @generated
	*/
	protected IndependentConcurrency getLink() {
		return (IndependentConcurrency) getElementToEdit();
	}
