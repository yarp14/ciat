 ...
 * @generated
 */
public class DisablingReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public DisablingReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Disabling) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return CiatBaseItemSemanticEditPolicy.getLinkConstraints().canExistDisabling_4009(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		CIATDiagram container = (CIATDiagram) getLink().eContainer();
		return CiatBaseItemSemanticEditPolicy.getLinkConstraints().canExistDisabling_4009(container, getLink(), source,
				getNewTarget());
	}
	...
	* @generated
	*/
	protected Disabling getLink() {
		return (Disabling) getElementToEdit();
	}
