 ...
 * @generated
 */
public class ShAssociationLinkReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ShAssociationLinkReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof ShAssociationLink) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return CiatBaseItemSemanticEditPolicy.getLinkConstraints().canExistShAssociationLink_4004(container, getLink(),
				getNewSource(), target);
	}
	...
	* @generated
	*/
	protected ShAssociationLink getLink() {
		return (ShAssociationLink) getElementToEdit();
	}
