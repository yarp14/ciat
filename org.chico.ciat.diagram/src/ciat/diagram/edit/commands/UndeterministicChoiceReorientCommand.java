 ...
 * @generated
 */
public class UndeterministicChoiceReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public UndeterministicChoiceReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof UndeterministicChoice) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return CiatBaseItemSemanticEditPolicy.getLinkConstraints().canExistUndeterministicChoice_4017(container,
	...
	* @generated
	*/
	protected UndeterministicChoice getLink() {
		return (UndeterministicChoice) getElementToEdit();
	}
