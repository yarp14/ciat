 ...
 * @generated
 */
public class EnablingReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public EnablingReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Enabling) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return CiatBaseItemSemanticEditPolicy.getLinkConstraints().canExistEnabling_4008(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		CIATDiagram container = (CIATDiagram) getLink().eContainer();
		return CiatBaseItemSemanticEditPolicy.getLinkConstraints().canExistEnabling_4008(container, getLink(), source,
				getNewTarget());
	}
	...
	* @generated
	*/
	protected Enabling getLink() {
		return (Enabling) getElementToEdit();
	}
