...
public class ActingReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return CiatBaseItemSemanticEditPolicy.getLinkConstraints().canExistActing_4002(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		CIATDiagram container = (CIATDiagram) getLink().eContainer();
		return CiatBaseItemSemanticEditPolicy.getLinkConstraints().canExistActing_4002(container, getLink(), source,
				getNewTarget());
	}
