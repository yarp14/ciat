 ...
 * @generated
 */
public class DeterministicChoiceReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public DeterministicChoiceReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof DeterministicChoice) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return CiatBaseItemSemanticEditPolicy.getLinkConstraints().canExistDeterministicChoice_4016(container,
	...
	* @generated
	*/
	protected DeterministicChoice getLink() {
		return (DeterministicChoice) getElementToEdit();
	}
