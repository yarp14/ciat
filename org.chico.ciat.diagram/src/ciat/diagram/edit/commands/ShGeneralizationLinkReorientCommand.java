 ...
 * @generated
 */
public class ShGeneralizationLinkReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ShGeneralizationLinkReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof ShGeneralizationLink) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return CiatBaseItemSemanticEditPolicy.getLinkConstraints().canExistShGeneralizationLink_4005(container,
	...
	* @generated
	*/
	protected ShGeneralizationLink getLink() {
		return (ShGeneralizationLink) getElementToEdit();
	}
