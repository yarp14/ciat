 ...
 * @generated
 */
public class IndividualTaskIndividualTaskTaskRolesCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return CiatPackage.eINSTANCE.getIndividualTask_TaskRoles();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getIndividualTaskIndividualTaskTaskRolesCompartment_7010SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getIndividualTaskIndividualTaskTaskRolesCompartment_7010SemanticChildren((View) getHost().getModel());
