 ...
 * @generated
 */
public class CollaborativeTaskCollaborativeTaskTaskRolesCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return CiatPackage.eINSTANCE.getCollaborativeTask_TaskRoles();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getCollaborativeTaskCollaborativeTaskTaskRolesCompartment_7014SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getCollaborativeTaskCollaborativeTaskTaskRolesCompartment_7014SemanticChildren(
