 ...
 * @generated
 */
public class CollaborativeTaskCollaborativeTaskTaskObjectsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return CiatPackage.eINSTANCE.getCollaborativeTask_TaskObjects();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getCollaborativeTaskCollaborativeTaskTaskObjectsCompartment_7015SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return Object3EditPart.VISUAL_ID == CiatVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getCollaborativeTaskCollaborativeTaskTaskObjectsCompartment_7015SemanticChildren(
