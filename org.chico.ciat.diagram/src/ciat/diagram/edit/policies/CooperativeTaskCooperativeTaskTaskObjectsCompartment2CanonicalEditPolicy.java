 ...
 * @generated
 */
public class CooperativeTaskCooperativeTaskTaskObjectsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return CiatPackage.eINSTANCE.getCooperativeTask_TaskObjects();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getCooperativeTaskCooperativeTaskTaskObjectsCompartment_7013SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return Object2EditPart.VISUAL_ID == CiatVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getCooperativeTaskCooperativeTaskTaskObjectsCompartment_7013SemanticChildren(
