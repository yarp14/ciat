 ...
 * @generated
 */
public class IndividualTaskIndividualTaskTaskObjectsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getIndividualTaskIndividualTaskTaskObjectsCompartment_7004SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getIndividualTaskIndividualTaskTaskObjectsCompartment_7004SemanticChildren(
