 ...
 * @generated
 */
public class CollaborativeTaskCollaborativeTaskTaskRolesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getCollaborativeTaskCollaborativeTaskTaskRolesCompartment_7007SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getCollaborativeTaskCollaborativeTaskTaskRolesCompartment_7007SemanticChildren(
