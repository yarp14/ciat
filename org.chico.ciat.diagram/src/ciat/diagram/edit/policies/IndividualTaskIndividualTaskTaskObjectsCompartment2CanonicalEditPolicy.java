 ...
 * @generated
 */
public class IndividualTaskIndividualTaskTaskObjectsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return CiatPackage.eINSTANCE.getIndividualTask_TaskObjects();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getIndividualTaskIndividualTaskTaskObjectsCompartment_7011SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return ObjectEditPart.VISUAL_ID == CiatVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getIndividualTaskIndividualTaskTaskObjectsCompartment_7011SemanticChildren(
