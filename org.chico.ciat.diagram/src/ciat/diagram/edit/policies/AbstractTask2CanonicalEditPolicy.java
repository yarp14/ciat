 ...
 * @generated
 */
public class AbstractTask2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return CiatPackage.eINSTANCE.getSimpleTask_Tools();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater.getAbstractTask_3032SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return ToolEditPart.VISUAL_ID == CiatVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getAbstractTask_3032SemanticChildren((View) getHost().getModel());
