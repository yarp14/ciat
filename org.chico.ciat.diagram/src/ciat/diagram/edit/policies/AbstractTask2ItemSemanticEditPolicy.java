...
import ciat.diagram.edit.commands.ToolCreateCommand;
 ...
 * @generated
 */
public class AbstractTask2ItemSemanticEditPolicy extends CiatBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public AbstractTask2ItemSemanticEditPolicy() {
		super(CiatElementTypes.AbstractTask_3032);
	}
	...
	*/
	protected Command getCreateCommand(CreateElementRequest req) {
		if (CiatElementTypes.Tool_3012 == req.getElementType()) {
				...
				for (Iterator<?> cit = node.getChildren().iterator(); cit.hasNext();) {
					...
					case IndividualTask2EditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it.hasNext();) {
							...
							if (CiatVisualIDRegistry
									.getVisualID(incomingLink) == EnablingWithInformationPassingEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
								continue;
							...
							if (CiatVisualIDRegistry
									.getVisualID(incomingLink) == DisablingWithInformationPassingEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
								continue;
							...
							if (CiatVisualIDRegistry
									.getVisualID(incomingLink) == IndependentConcurrencyEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
								continue;
							...
							if (CiatVisualIDRegistry
									.getVisualID(incomingLink) == DeterministicChoiceEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
								continue;
							...
							if (CiatVisualIDRegistry
									.getVisualID(incomingLink) == UndeterministicChoiceEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
								continue;
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (CiatVisualIDRegistry
									.getVisualID(outgoingLink) == EnablingWithInformationPassingEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(outgoingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
								continue;
							...
							if (CiatVisualIDRegistry
									.getVisualID(outgoingLink) == DisablingWithInformationPassingEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(outgoingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
								continue;
							...
							if (CiatVisualIDRegistry
									.getVisualID(outgoingLink) == IndependentConcurrencyEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(outgoingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
								continue;
							...
							if (CiatVisualIDRegistry
									.getVisualID(outgoingLink) == DeterministicChoiceEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(outgoingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
								continue;
							...
							if (CiatVisualIDRegistry
									.getVisualID(outgoingLink) == UndeterministicChoiceEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(outgoingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
								continue;
