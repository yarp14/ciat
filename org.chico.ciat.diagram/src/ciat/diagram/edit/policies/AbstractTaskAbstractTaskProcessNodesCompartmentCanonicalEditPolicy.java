 ...
 * @generated
 */
public class AbstractTaskAbstractTaskProcessNodesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getAbstractTaskAbstractTaskProcessNodesCompartment_7009SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getAbstractTaskAbstractTaskProcessNodesCompartment_7009SemanticChildren((View) getHost().getModel());
