 ...
 * @generated
 */
public class SharedObjectCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return CiatPackage.eINSTANCE.getSharedObject_VAreas();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater.getSharedObject_3043SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == ExclusiveEditionAreaEditPart.VISUAL_ID || visualID == CollaborativeAreaEditPart.VISUAL_ID
				|| visualID == IndividualAreaEditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getSharedObject_3043SemanticChildren((View) getHost().getModel());
