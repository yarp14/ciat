 ...
 * @generated
 */
public class ProcessDiagramProcessDiagramProcessNodesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return CiatPackage.eINSTANCE.getProcessDiagram_ProcessNodes();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getProcessDiagramProcessDiagramProcessNodesCompartment_7002SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getProcessDiagramProcessDiagramProcessNodesCompartment_7002SemanticChildren(
