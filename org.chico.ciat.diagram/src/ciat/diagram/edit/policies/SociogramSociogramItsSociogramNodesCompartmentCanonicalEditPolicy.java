 ...
 * @generated
 */
public class SociogramSociogramItsSociogramNodesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return CiatPackage.eINSTANCE.getSociogram_ItsSociogramNodes();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getSociogramSociogramItsSociogramNodesCompartment_7001SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getSociogramSociogramItsSociogramNodesCompartment_7001SemanticChildren((View) getHost().getModel());
