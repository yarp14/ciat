 ...
 * @generated
 */
public class CollaborativeTaskCollaborativeTaskTaskObjectsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getCollaborativeTaskCollaborativeTaskTaskObjectsCompartment_7008SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getCollaborativeTaskCollaborativeTaskTaskObjectsCompartment_7008SemanticChildren(
