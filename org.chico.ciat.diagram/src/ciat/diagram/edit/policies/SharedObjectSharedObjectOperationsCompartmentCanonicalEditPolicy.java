 ...
 * @generated
 */
public class SharedObjectSharedObjectOperationsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return CiatPackage.eINSTANCE.getSharedObject_Operations();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getSharedObjectSharedObjectOperationsCompartment_7019SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return OperationEditPart.VISUAL_ID == CiatVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getSharedObjectSharedObjectOperationsCompartment_7019SemanticChildren((View) getHost().getModel());
