 ...
 * @generated
 */
public class IndividualTaskIndividualTaskTaskRolesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getIndividualTaskIndividualTaskTaskRolesCompartment_7003SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getIndividualTaskIndividualTaskTaskRolesCompartment_7003SemanticChildren((View) getHost().getModel());
