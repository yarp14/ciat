 ...
 * @generated
 */
public class DomainDiagramDomainDiagramSharedContextCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return CiatPackage.eINSTANCE.getDomainDiagram_SharedContext();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getDomainDiagramDomainDiagramSharedContextCompartment_7017SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return SharedObjectEditPart.VISUAL_ID == CiatVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getDomainDiagramDomainDiagramSharedContextCompartment_7017SemanticChildren(
