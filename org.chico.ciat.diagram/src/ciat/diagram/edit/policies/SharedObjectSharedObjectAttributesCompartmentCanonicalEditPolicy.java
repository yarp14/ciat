 ...
 * @generated
 */
public class SharedObjectSharedObjectAttributesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return CiatPackage.eINSTANCE.getSharedObject_Attributes();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getSharedObjectSharedObjectAttributesCompartment_7018SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return AttributeEditPart.VISUAL_ID == CiatVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getSharedObjectSharedObjectAttributesCompartment_7018SemanticChildren((View) getHost().getModel());
