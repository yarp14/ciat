 ...
 * @generated
 */
public class AbstractTaskAbstractTaskProcessNodesCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return CiatPackage.eINSTANCE.getAbstractTask_ProcessNodes();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getAbstractTaskAbstractTaskProcessNodesCompartment_7016SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getAbstractTaskAbstractTaskProcessNodesCompartment_7016SemanticChildren((View) getHost().getModel());
