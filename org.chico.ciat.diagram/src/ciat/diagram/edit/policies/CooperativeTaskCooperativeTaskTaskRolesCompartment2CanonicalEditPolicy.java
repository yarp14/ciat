 ...
 * @generated
 */
public class CooperativeTaskCooperativeTaskTaskRolesCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return CiatPackage.eINSTANCE.getCooperativeTask_TaskRoles();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getCooperativeTaskCooperativeTaskTaskRolesCompartment_7012SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getCooperativeTaskCooperativeTaskTaskRolesCompartment_7012SemanticChildren(
