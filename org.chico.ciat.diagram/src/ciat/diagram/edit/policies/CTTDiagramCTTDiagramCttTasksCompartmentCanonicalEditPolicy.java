 ...
 * @generated
 */
public class CTTDiagramCTTDiagramCttTasksCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return CiatPackage.eINSTANCE.getCTTDiagram_CttTasks();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getCTTDiagramCTTDiagramCttTasksCompartment_7020SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getCTTDiagramCTTDiagramCttTasksCompartment_7020SemanticChildren((View) getHost().getModel());
