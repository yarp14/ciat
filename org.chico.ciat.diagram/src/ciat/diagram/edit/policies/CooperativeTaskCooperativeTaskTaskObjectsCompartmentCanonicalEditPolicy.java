 ...
 * @generated
 */
public class CooperativeTaskCooperativeTaskTaskObjectsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getCooperativeTaskCooperativeTaskTaskObjectsCompartment_7006SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<CiatNodeDescriptor> childDescriptors = CiatDiagramUpdater
				.getCooperativeTaskCooperativeTaskTaskObjectsCompartment_7006SemanticChildren(
