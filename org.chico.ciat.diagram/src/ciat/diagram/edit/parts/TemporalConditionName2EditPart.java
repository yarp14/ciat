 ...
 * @generated
 */
public class TemporalConditionName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TemporalConditionName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.TemporalCondition_3040, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.TemporalConditionName2EditPart.VISUAL_ID));
		}
		return parser;
	}
