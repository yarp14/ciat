...
public class AttributeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Attribute_3047, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.AttributeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
