 ...
 * @generated
 */
public class UndeterministicChoiceUcLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.UndeterministicChoiceUcLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public UndeterministicChoiceUcLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.UndeterministicChoice_4017, getParserElement(),
					CiatVisualIDRegistry
							.getType(ciat.diagram.edit.parts.UndeterministicChoiceUcLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new UndeterministicChoiceLabelFigure();
	}

	/**
	 * @generated
	 */
	public class UndeterministicChoiceLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public UndeterministicChoiceLabelFigure() {
			this.setText("UndeterministicChoice");
		}
