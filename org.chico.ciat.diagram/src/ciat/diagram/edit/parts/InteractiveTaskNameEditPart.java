 ...
 * @generated
 */
public class InteractiveTaskNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.InteractiveTaskNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public InteractiveTaskNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.InteractiveTask_3054, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.InteractiveTaskNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new InteractiveTaskLabelFigure();
	}

	/**
	 * @generated
	 */
	public class InteractiveTaskLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public InteractiveTaskLabelFigure() {
			this.setText("InteractiveTask");
		}
