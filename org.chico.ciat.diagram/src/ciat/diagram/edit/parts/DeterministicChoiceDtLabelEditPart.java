 ...
 * @generated
 */
public class DeterministicChoiceDtLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.DeterministicChoiceDtLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public DeterministicChoiceDtLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.DeterministicChoice_4016, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.DeterministicChoiceDtLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new DeterministicChoiceLabelFigure();
	}

	/**
	 * @generated
	 */
	public class DeterministicChoiceLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public DeterministicChoiceLabelFigure() {
			this.setText("DeterministicChoice");
		}
