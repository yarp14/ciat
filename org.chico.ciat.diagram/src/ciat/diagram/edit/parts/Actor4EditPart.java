...
import ciat.diagram.edit.policies.Actor4ItemSemanticEditPolicy;
import ciat.diagram.part.CiatVisualIDRegistry;

/**
 * @generated
 */
public class Actor4EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ActorName4EditPart) {
			((ActorName4EditPart) childEditPart).setLabel(getPrimaryShape().getFigureActorLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CiatVisualIDRegistry.getType(ActorName4EditPart.VISUAL_ID));
	}
