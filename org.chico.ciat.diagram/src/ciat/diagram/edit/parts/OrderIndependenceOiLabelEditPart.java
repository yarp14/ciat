 ...
 * @generated
 */
public class OrderIndependenceOiLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.OrderIndependenceOiLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public OrderIndependenceOiLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.OrderIndependence_4013, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.OrderIndependenceOiLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new OrderIndependenceLabelFigure();
	}

	/**
	 * @generated
	 */
	public class OrderIndependenceLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public OrderIndependenceLabelFigure() {
			this.setText("OrderIndependence");
		}
