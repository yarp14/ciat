 ...
 * @generated
 */
public class TeamName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TeamName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Team_3010, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.TeamName2EditPart.VISUAL_ID));
		}
		return parser;
	}
