 ...
 * @generated
 */
public class IndividualTaskNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public IndividualTaskNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.IndividualTask_3006, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.IndividualTaskNameEditPart.VISUAL_ID));
		}
		return parser;
	}
