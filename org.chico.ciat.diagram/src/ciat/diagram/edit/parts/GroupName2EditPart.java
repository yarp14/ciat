 ...
 * @generated
 */
public class GroupName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Group_3011, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.GroupName2EditPart.VISUAL_ID));
		}
		return parser;
	}
