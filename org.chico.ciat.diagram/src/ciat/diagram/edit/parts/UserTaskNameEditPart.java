 ...
 * @generated
 */
public class UserTaskNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.UserTaskNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public UserTaskNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.UserTask_3052, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.UserTaskNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new UserTaskLabelFigure();
	}

	/**
	 * @generated
	 */
	public class UserTaskLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public UserTaskLabelFigure() {
			this.setText("UserTask");
		}
