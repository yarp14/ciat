 ...
 * @generated
 */
public class RolNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RolNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Rol_3001, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.RolNameEditPart.VISUAL_ID));
		}
		return parser;
	}
