 ...
 * @generated
 */
public class CollaborativeVisualizationNameEditPart extends LabelEditPart
	...
	*/
	static {
		registerSnapBackPosition(
				CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.CollaborativeVisualizationNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public CollaborativeVisualizationNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.CollaborativeVisualization_3050, getParserElement(),
					CiatVisualIDRegistry
							.getType(ciat.diagram.edit.parts.CollaborativeVisualizationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new CollaborativeVisualizationLabelFigure();
	}

	/**
	 * @generated
	 */
	public class CollaborativeVisualizationLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public CollaborativeVisualizationLabelFigure() {
			this.setText("CollaborativeVisualization");
		}
