 ...
 * @generated
 */
public class ExclusiveEditionAreaNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.ExclusiveEditionAreaNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public ExclusiveEditionAreaNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.ExclusiveEditionArea_3044, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.ExclusiveEditionAreaNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ExclusiveEditionAreaLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ExclusiveEditionAreaLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ExclusiveEditionAreaLabelFigure() {
			this.setText("ExclusiveEditionArea");
		}
