 ...
 * @generated
 */
public class DisablingWithInformationPassingDwLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				CiatVisualIDRegistry
						.getType(ciat.diagram.edit.parts.DisablingWithInformationPassingDwLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public DisablingWithInformationPassingDwLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.DisablingWithInformationPassing_4011,
					getParserElement(), CiatVisualIDRegistry
							.getType(ciat.diagram.edit.parts.DisablingWithInformationPassingDwLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new DisablingWithInformationPassingLabelFigure();
	}

	/**
	 * @generated
	 */
	public class DisablingWithInformationPassingLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public DisablingWithInformationPassingLabelFigure() {
			this.setText("DisablingWithInformationPassing");
		}
