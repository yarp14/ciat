...
import ciat.diagram.edit.policies.SociogramItemSemanticEditPolicy;
...
public class SociogramEditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CiatVisualIDRegistry.getType(SociogramNameEditPart.VISUAL_ID));
	}
