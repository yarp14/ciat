 ...
 * @generated
 */
public class TeamName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TeamName3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Team_3018, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.TeamName3EditPart.VISUAL_ID));
		}
		return parser;
	}
