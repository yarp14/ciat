...
public class TeamNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Team_3004, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.TeamNameEditPart.VISUAL_ID));
		}
		return parser;
	}
