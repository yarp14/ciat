 ...
 * @generated
 */
public class CTTCollaborativeTaskNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.CTTCollaborativeTaskNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public CTTCollaborativeTaskNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.CTTCollaborativeTask_3055, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.CTTCollaborativeTaskNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new CTTCollaborativeTaskLabelFigure();
	}

	/**
	 * @generated
	 */
	public class CTTCollaborativeTaskLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public CTTCollaborativeTaskLabelFigure() {
			this.setText("CTTCollaborativeTask");
		}
