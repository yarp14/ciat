 ...
 * @generated
 */
public class CooperativeTaskNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CooperativeTaskNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.CooperativeTask_3014, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.CooperativeTaskNameEditPart.VISUAL_ID));
		}
		return parser;
	}
