 ...
 * @generated
 */
public class ExclusiveEditionNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.ExclusiveEditionNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public ExclusiveEditionNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.ExclusiveEdition_3049, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.ExclusiveEditionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ExclusiveEditionLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ExclusiveEditionLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ExclusiveEditionLabelFigure() {
			this.setText("ExclusiveEdition");
		}
