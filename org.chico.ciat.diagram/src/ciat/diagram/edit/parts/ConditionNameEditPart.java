...
public class ConditionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Condition_3037, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.ConditionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
