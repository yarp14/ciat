 ...
 * @generated
 */
public class SoftwareAgentName4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SoftwareAgentName4EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.SoftwareAgent_3024, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.SoftwareAgentName4EditPart.VISUAL_ID));
		}
		return parser;
	}
