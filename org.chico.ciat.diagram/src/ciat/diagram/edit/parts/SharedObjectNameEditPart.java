 ...
 * @generated
 */
public class SharedObjectNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SharedObjectNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.SharedObject_3043, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.SharedObjectNameEditPart.VISUAL_ID));
		}
		return parser;
	}
