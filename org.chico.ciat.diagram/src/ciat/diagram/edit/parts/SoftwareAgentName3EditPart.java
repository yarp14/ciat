 ...
 * @generated
 */
public class SoftwareAgentName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SoftwareAgentName3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.SoftwareAgent_3017, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.SoftwareAgentName3EditPart.VISUAL_ID));
		}
		return parser;
	}
