 ...
 * @generated
 */
public class CTTDiagramNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CTTDiagramNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.CTTDiagram_2004, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.CTTDiagramNameEditPart.VISUAL_ID));
		}
		return parser;
	}
