 ...
 * @generated
 */
public class ConditionName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ConditionName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Condition_3042, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.ConditionName2EditPart.VISUAL_ID));
		}
		return parser;
	}
