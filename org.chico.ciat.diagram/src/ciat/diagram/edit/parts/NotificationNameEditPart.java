 ...
 * @generated
 */
public class NotificationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public NotificationNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Notification_3036, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.NotificationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
