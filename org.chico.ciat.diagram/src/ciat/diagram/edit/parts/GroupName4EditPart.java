 ...
 * @generated
 */
public class GroupName4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public GroupName4EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Group_3026, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.GroupName4EditPart.VISUAL_ID));
		}
		return parser;
	}
