...
import ciat.diagram.edit.policies.Actor2ItemSemanticEditPolicy;
import ciat.diagram.part.CiatVisualIDRegistry;

/**
 * @generated
 */
public class Actor2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ActorName2EditPart) {
			((ActorName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureActorLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CiatVisualIDRegistry.getType(ActorName2EditPart.VISUAL_ID));
	}
