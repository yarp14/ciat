 ...
 * @generated
 */
public class GroupName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public GroupName3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Group_3019, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.GroupName3EditPart.VISUAL_ID));
		}
		return parser;
	}
