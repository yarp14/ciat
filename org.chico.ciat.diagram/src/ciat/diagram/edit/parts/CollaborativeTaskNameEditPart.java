 ...
 * @generated
 */
public class CollaborativeTaskNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CollaborativeTaskNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.CollaborativeTask_3021, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.CollaborativeTaskNameEditPart.VISUAL_ID));
		}
		return parser;
	}
