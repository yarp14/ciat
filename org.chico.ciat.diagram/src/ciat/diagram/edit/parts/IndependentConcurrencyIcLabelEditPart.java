 ...
 * @generated
 */
public class IndependentConcurrencyIcLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.IndependentConcurrencyIcLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public IndependentConcurrencyIcLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.IndependentConcurrency_4012, getParserElement(),
					CiatVisualIDRegistry
							.getType(ciat.diagram.edit.parts.IndependentConcurrencyIcLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new IndependentConcurrencyLabelFigure();
	}

	/**
	 * @generated
	 */
	public class IndependentConcurrencyLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public IndependentConcurrencyLabelFigure() {
			this.setText("IndependentConcurrency");
		}
