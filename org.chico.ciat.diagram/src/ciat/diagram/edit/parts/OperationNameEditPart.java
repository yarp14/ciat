...
public class OperationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Operation_3048, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.OperationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
