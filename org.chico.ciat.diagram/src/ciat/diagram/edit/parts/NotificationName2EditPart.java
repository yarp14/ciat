 ...
 * @generated
 */
public class NotificationName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public NotificationName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Notification_3041, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.NotificationName2EditPart.VISUAL_ID));
		}
		return parser;
	}
