 ...
 * @generated
 */
public class ConcurrencyWithInformationPassingCLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				CiatVisualIDRegistry
						.getType(ciat.diagram.edit.parts.ConcurrencyWithInformationPassingCLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public ConcurrencyWithInformationPassingCLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.ConcurrencyWithInformationPassing_4015,
					getParserElement(), CiatVisualIDRegistry.getType(
							ciat.diagram.edit.parts.ConcurrencyWithInformationPassingCLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ConcurrencyWithInformationPassingLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ConcurrencyWithInformationPassingLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ConcurrencyWithInformationPassingLabelFigure() {
			this.setText("ConcurrencyWithInformationPassing");
		}
