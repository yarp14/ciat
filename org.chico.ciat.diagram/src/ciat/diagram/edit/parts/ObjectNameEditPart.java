 ...
 * @generated
 */
public class ObjectNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ObjectNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Object_3013, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.ObjectNameEditPart.VISUAL_ID));
		}
		return parser;
	}
