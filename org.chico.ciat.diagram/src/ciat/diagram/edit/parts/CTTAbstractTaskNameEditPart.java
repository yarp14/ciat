 ...
 * @generated
 */
public class CTTAbstractTaskNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.CTTAbstractTaskNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public CTTAbstractTaskNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.CTTAbstractTask_3053, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.CTTAbstractTaskNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new CTTAbstractTaskLabelFigure();
	}

	/**
	 * @generated
	 */
	public class CTTAbstractTaskLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public CTTAbstractTaskLabelFigure() {
			this.setText("CTTAbstractTask");
		}
