...
import ciat.diagram.edit.policies.CollaborativeTaskCanonicalEditPolicy;
import ciat.diagram.edit.policies.CollaborativeTaskItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CollaborativeTaskEditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public CollaborativeTaskEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CollaborativeTaskItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new CollaborativeTaskCanonicalEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CollaborativeTaskNameEditPart) {
			((CollaborativeTaskNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureCollaborativeTaskLabelFigure());
			return true;
		}
		if (childEditPart instanceof CollaborativeTaskCollaborativeTaskTaskRolesCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getCollaborativeTaskTaskRolesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((CollaborativeTaskCollaborativeTaskTaskRolesCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof CollaborativeTaskCollaborativeTaskTaskObjectsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getCollaborativeTaskTaskObjectsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((CollaborativeTaskCollaborativeTaskTaskObjectsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof CollaborativeTaskCollaborativeTaskTaskRolesCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getCollaborativeTaskTaskRolesCompartmentFigure();
			pane.remove(((CollaborativeTaskCollaborativeTaskTaskRolesCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof CollaborativeTaskCollaborativeTaskTaskObjectsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getCollaborativeTaskTaskObjectsCompartmentFigure();
			pane.remove(((CollaborativeTaskCollaborativeTaskTaskObjectsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof ToolEditPart) {
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof CollaborativeTaskCollaborativeTaskTaskRolesCompartmentEditPart) {
			return getPrimaryShape().getCollaborativeTaskTaskRolesCompartmentFigure();
		}
		if (editPart instanceof CollaborativeTaskCollaborativeTaskTaskObjectsCompartmentEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CiatVisualIDRegistry.getType(CollaborativeTaskNameEditPart.VISUAL_ID));
	}
