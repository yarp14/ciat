...
import ciat.diagram.edit.policies.Group4ItemSemanticEditPolicy;
import ciat.diagram.part.CiatVisualIDRegistry;

/**
 * @generated
 */
public class Group4EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Group4EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Group4ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof GroupName4EditPart) {
			((GroupName4EditPart) childEditPart).setLabel(getPrimaryShape().getFigureGroupLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CiatVisualIDRegistry.getType(GroupName4EditPart.VISUAL_ID));
	}
