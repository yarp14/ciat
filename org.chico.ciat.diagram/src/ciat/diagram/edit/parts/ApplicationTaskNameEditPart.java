 ...
 * @generated
 */
public class ApplicationTaskNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.ApplicationTaskNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public ApplicationTaskNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.ApplicationTask_3056, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.ApplicationTaskNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ApplicationTaskLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ApplicationTaskLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ApplicationTaskLabelFigure() {
			this.setText("ApplicationTask");
		}
