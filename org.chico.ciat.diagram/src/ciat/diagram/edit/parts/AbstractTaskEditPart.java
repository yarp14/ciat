...
import ciat.diagram.edit.policies.AbstractTaskCanonicalEditPolicy;
import ciat.diagram.edit.policies.AbstractTaskItemSemanticEditPolicy;
...
public class AbstractTaskEditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof AbstractTaskAbstractTaskProcessNodesCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getAbstractTaskProcessNodesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((AbstractTaskAbstractTaskProcessNodesCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof AbstractTaskAbstractTaskProcessNodesCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getAbstractTaskProcessNodesCompartmentFigure();
			pane.remove(((AbstractTaskAbstractTaskProcessNodesCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof ToolEditPart) {
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof AbstractTaskAbstractTaskProcessNodesCompartmentEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CiatVisualIDRegistry.getType(AbstractTaskNameEditPart.VISUAL_ID));
	}
