 ...
 * @generated
 */
public class TemporalConditionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TemporalConditionNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.TemporalCondition_3035, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.TemporalConditionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
