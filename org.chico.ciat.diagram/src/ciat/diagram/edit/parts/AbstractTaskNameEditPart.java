 ...
 * @generated
 */
public class AbstractTaskNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AbstractTaskNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.AbstractTask_3028, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.AbstractTaskNameEditPart.VISUAL_ID));
		}
		return parser;
	}
