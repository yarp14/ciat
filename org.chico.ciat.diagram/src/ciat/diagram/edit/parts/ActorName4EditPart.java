 ...
 * @generated
 */
public class ActorName4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ActorName4EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Actor_3023, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.ActorName4EditPart.VISUAL_ID));
		}
		return parser;
	}
