 ...
 * @generated
 */
public class InheritanceConditionEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.InheritanceConditionEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public InheritanceConditionEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Inheritance_4001, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.InheritanceConditionEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new InheritanceLabelFigure();
	}

	/**
	 * @generated
	 */
	public class InheritanceLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public InheritanceLabelFigure() {
			this.setText("Inheritance");
		}
