 ...
 * @generated
 */
public class IndividualAreaNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.IndividualAreaNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public IndividualAreaNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.IndividualArea_3046, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.IndividualAreaNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new IndividualAreaLabelFigure();
	}

	/**
	 * @generated
	 */
	public class IndividualAreaLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public IndividualAreaLabelFigure() {
			this.setText("IndividualArea");
		}
