...
import ciat.diagram.edit.policies.CooperativeTaskCanonicalEditPolicy;
import ciat.diagram.edit.policies.CooperativeTaskItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CooperativeTaskEditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public CooperativeTaskEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CooperativeTaskItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new CooperativeTaskCanonicalEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CooperativeTaskNameEditPart) {
			((CooperativeTaskNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureCooperativeTaskLabelFigure());
			return true;
		}
		if (childEditPart instanceof CooperativeTaskCooperativeTaskTaskRolesCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getCooperativeTaskTaskRolesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((CooperativeTaskCooperativeTaskTaskRolesCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof CooperativeTaskCooperativeTaskTaskObjectsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getCooperativeTaskTaskObjectsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((CooperativeTaskCooperativeTaskTaskObjectsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof CooperativeTaskCooperativeTaskTaskRolesCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getCooperativeTaskTaskRolesCompartmentFigure();
			pane.remove(((CooperativeTaskCooperativeTaskTaskRolesCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof CooperativeTaskCooperativeTaskTaskObjectsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getCooperativeTaskTaskObjectsCompartmentFigure();
			pane.remove(((CooperativeTaskCooperativeTaskTaskObjectsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof ToolEditPart) {
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof CooperativeTaskCooperativeTaskTaskRolesCompartmentEditPart) {
			return getPrimaryShape().getCooperativeTaskTaskRolesCompartmentFigure();
		}
		if (editPart instanceof CooperativeTaskCooperativeTaskTaskObjectsCompartmentEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CiatVisualIDRegistry.getType(CooperativeTaskNameEditPart.VISUAL_ID));
	}
		...
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == CiatElementTypes.Rol_3015) {
				return getChildBySemanticHint(CiatVisualIDRegistry
						.getType(CooperativeTaskCooperativeTaskTaskRolesCompartmentEditPart.VISUAL_ID));
			}
