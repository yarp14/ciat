 ...
 * @generated
 */
public class ObjectName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ObjectName3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Object_3027, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.ObjectName3EditPart.VISUAL_ID));
		}
		return parser;
	}
