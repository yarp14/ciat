...
public class ActorNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Actor_3002, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.ActorNameEditPart.VISUAL_ID));
		}
		return parser;
	}
