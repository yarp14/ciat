 ...
 * @generated
 */
public class DisablingDLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.DisablingDLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public DisablingDLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Disabling_4009, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.DisablingDLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new DisablingLabelFigure();
	}

	/**
	 * @generated
	 */
	public class DisablingLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public DisablingLabelFigure() {
			this.setText("Disabling");
		}
