 ...
 * @generated
 */
public class DomainDiagramNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DomainDiagramNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.DomainDiagram_2003, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.DomainDiagramNameEditPart.VISUAL_ID));
		}
		return parser;
	}
