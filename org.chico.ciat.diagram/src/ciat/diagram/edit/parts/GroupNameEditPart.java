 ...
 * @generated
 */
public class GroupNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Group_3005, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.GroupNameEditPart.VISUAL_ID));
		}
		return parser;
	}
