 ...
 * @generated
 */
public class EnablingWithInformationPassingEwLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				CiatVisualIDRegistry
						.getType(ciat.diagram.edit.parts.EnablingWithInformationPassingEwLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public EnablingWithInformationPassingEwLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.EnablingWithInformationPassing_4010,
	...
	*/
	protected IFigure createFigurePrim() {
		return new EnablingWithInformationPassingLabelFigure();
	}

	/**
	 * @generated
	 */
	public class EnablingWithInformationPassingLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public EnablingWithInformationPassingLabelFigure() {
			this.setText("EnablingWithInformationPassing");
		}
