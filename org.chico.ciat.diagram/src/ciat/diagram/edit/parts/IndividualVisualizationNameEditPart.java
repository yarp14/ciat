 ...
 * @generated
 */
public class IndividualVisualizationNameEditPart extends LabelEditPart
	...
	*/
	static {
		registerSnapBackPosition(
				CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.IndividualVisualizationNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public IndividualVisualizationNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.IndividualVisualization_3051, getParserElement(),
					CiatVisualIDRegistry
							.getType(ciat.diagram.edit.parts.IndividualVisualizationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new IndividualVisualizationLabelFigure();
	}

	/**
	 * @generated
	 */
	public class IndividualVisualizationLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public IndividualVisualizationLabelFigure() {
			this.setText("IndividualVisualization");
		}
