 ...
 * @generated
 */
public class SoftwareAgentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SoftwareAgentNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.SoftwareAgent_3003, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.SoftwareAgentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
