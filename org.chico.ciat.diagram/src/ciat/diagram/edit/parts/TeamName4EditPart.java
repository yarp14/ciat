 ...
 * @generated
 */
public class TeamName4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TeamName4EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Team_3025, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.TeamName4EditPart.VISUAL_ID));
		}
		return parser;
	}
