 ...
 * @generated
 */
public class EnablingELabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.EnablingELabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public EnablingELabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Enabling_4008, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.EnablingELabelEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new EnablingLabelFigure();
	}

	/**
	 * @generated
	 */
	public class EnablingLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public EnablingLabelFigure() {
			this.setText("Enabling");
		}
