...
import ciat.diagram.edit.policies.IndividualTaskCanonicalEditPolicy;
import ciat.diagram.edit.policies.IndividualTaskItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IndividualTaskEditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public IndividualTaskEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new IndividualTaskItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new IndividualTaskCanonicalEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof IndividualTaskNameEditPart) {
			((IndividualTaskNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureIndividualTaskLabelFigure());
			return true;
		}
		if (childEditPart instanceof IndividualTaskIndividualTaskTaskRolesCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getIndividualTaskTaskRolesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((IndividualTaskIndividualTaskTaskRolesCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof IndividualTaskIndividualTaskTaskObjectsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getIndividualTaskTaskObjectsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((IndividualTaskIndividualTaskTaskObjectsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof IndividualTaskIndividualTaskTaskRolesCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getIndividualTaskTaskRolesCompartmentFigure();
			pane.remove(((IndividualTaskIndividualTaskTaskRolesCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof IndividualTaskIndividualTaskTaskObjectsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getIndividualTaskTaskObjectsCompartmentFigure();
			pane.remove(((IndividualTaskIndividualTaskTaskObjectsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof ToolEditPart) {
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof IndividualTaskIndividualTaskTaskRolesCompartmentEditPart) {
			return getPrimaryShape().getIndividualTaskTaskRolesCompartmentFigure();
		}
		if (editPart instanceof IndividualTaskIndividualTaskTaskObjectsCompartmentEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CiatVisualIDRegistry.getType(IndividualTaskNameEditPart.VISUAL_ID));
	}
		...
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == CiatElementTypes.Rol_3007) {
				return getChildBySemanticHint(CiatVisualIDRegistry
						.getType(IndividualTaskIndividualTaskTaskRolesCompartmentEditPart.VISUAL_ID));
			}
