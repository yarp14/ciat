 ...
 * @generated
 */
public class SociogramNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SociogramNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Sociogram_2001, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.SociogramNameEditPart.VISUAL_ID));
		}
		return parser;
	}
