 ...
 * @generated
 */
public class SuspendResumeSrLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.SuspendResumeSrLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public SuspendResumeSrLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.SuspendResume_4014, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.SuspendResumeSrLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new SuspendResumeLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SuspendResumeLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public SuspendResumeLabelFigure() {
			this.setText("SuspendResume");
		}
