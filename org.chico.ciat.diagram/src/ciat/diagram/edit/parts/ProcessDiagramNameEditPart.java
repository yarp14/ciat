 ...
 * @generated
 */
public class ProcessDiagramNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ProcessDiagramNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.ProcessDiagram_2002, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.ProcessDiagramNameEditPart.VISUAL_ID));
		}
		return parser;
	}
