...
import ciat.diagram.edit.policies.Group3ItemSemanticEditPolicy;
import ciat.diagram.part.CiatVisualIDRegistry;

/**
 * @generated
 */
public class Group3EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Group3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Group3ItemSemanticEditPolicy());
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CiatVisualIDRegistry.getType(GroupName3EditPart.VISUAL_ID));
	}
