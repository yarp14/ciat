 ...
 * @generated
 */
public class ActingNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.ActingNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public ActingNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Acting_4002, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.ActingNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ActingLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ActingLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ActingLabelFigure() {
			this.setText("Acting");
		}
