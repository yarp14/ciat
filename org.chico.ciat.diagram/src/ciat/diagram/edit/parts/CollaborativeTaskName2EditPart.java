 ...
 * @generated
 */
public class CollaborativeTaskName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CollaborativeTaskName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.CollaborativeTask_3031, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.CollaborativeTaskName2EditPart.VISUAL_ID));
		}
		return parser;
	}
