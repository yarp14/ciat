 ...
 * @generated
 */
public class ObjectName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ObjectName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Object_3020, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.ObjectName2EditPart.VISUAL_ID));
		}
		return parser;
	}
