 ...
 * @generated
 */
public class ToolNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ToolNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Tool_3012, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.ToolNameEditPart.VISUAL_ID));
		}
		return parser;
	}
