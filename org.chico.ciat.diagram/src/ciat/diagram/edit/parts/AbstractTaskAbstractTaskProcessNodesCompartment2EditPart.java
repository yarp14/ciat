...
import ciat.diagram.edit.policies.AbstractTaskAbstractTaskProcessNodesCompartment2CanonicalEditPolicy;
import ciat.diagram.edit.policies.AbstractTaskAbstractTaskProcessNodesCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AbstractTaskAbstractTaskProcessNodesCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public AbstractTaskAbstractTaskProcessNodesCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.AbstractTaskAbstractTaskProcessNodesCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AbstractTaskAbstractTaskProcessNodesCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(CiatVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new AbstractTaskAbstractTaskProcessNodesCompartment2CanonicalEditPolicy());
	}
