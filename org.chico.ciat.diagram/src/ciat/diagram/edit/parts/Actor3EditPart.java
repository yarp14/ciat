...
import ciat.diagram.edit.policies.Actor3ItemSemanticEditPolicy;
import ciat.diagram.part.CiatVisualIDRegistry;

/**
 * @generated
 */
public class Actor3EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ActorName3EditPart) {
			((ActorName3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureActorLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CiatVisualIDRegistry.getType(ActorName3EditPart.VISUAL_ID));
	}
