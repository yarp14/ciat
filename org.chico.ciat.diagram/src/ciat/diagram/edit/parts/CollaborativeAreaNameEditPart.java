 ...
 * @generated
 */
public class CollaborativeAreaNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.CollaborativeAreaNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public CollaborativeAreaNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.CollaborativeArea_3045, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.CollaborativeAreaNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new CollaborativeAreaLabelFigure();
	}

	/**
	 * @generated
	 */
	public class CollaborativeAreaLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public CollaborativeAreaLabelFigure() {
			this.setText("CollaborativeArea");
		}
