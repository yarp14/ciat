 ...
 * @generated
 */
public class CiatModelingAssistantProviderOfTeamEditPart extends CiatModelingAssistantProvider {
	...
	*/
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((TeamEditPart) targetEditPart, relationshipType);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetTypesForSource(TeamEditPart target, IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
		if (relationshipType == CiatElementTypes.Inheritance_4001) {
			types.add(CiatElementTypes.Rol_3001);
			types.add(CiatElementTypes.Actor_3002);
